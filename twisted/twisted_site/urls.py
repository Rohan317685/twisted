...
urlpatterns = [
    ...
    path("admin/pathways/<int:id>", admin.PathwayDetailView.as_view(), name="admin.pathways.detail"),
    path("admin/pathways/new/", admin.PathwayCreateView.as_view(), name="admin.pathways.create"),
